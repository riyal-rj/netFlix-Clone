    ...
    <div className='hero_bg relative'>
            ...
            <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2 '>
                ...
                <div className='flex-1 text-center md:text-left'>
                    ...
                    <p className='text-lg md:text-xl'>
                        Watch on your smart TVs, PlayStation, Xbox, Chromecast, Apple TV, Blu-ray players, and more.
                    </p>
                </div>
                {/* {rightside} */}
        ...
        <div className='py-10 bg-black text-white'>
            <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
                {/*leftside */}
                <div className='flex-1 text-center md:text-left'>
                    <h2 className='text-4xl md:text-5xl font font-extrabold mb-4'>
                        Watch everywhere
                    </h2>
                    <p className='text-lg md:text-xl'>
        ...
        <div className='py-10 bg-black text-white'>
            <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
                ...
                <div className='flex-1 text-center md:text-left'>
                    ...
                    <p className='text-lg md:text-xl'>
                        Send kids on adventure with their favourite character in a space made just for them free with your membership.
                    </p>
                </div>
            </div>
        </div>
        ...
        <FAQSection/>
         ...
         {/*section-6 */}
        <div className='bg-black flex flex-col items-center justify-center text-center py-4 text-white '>
            <p className='mb-4'>
                Ready to watch? Enter your email to create or restart your membership.
            </p>
            <form className='flex flex-col md:flex-row gap-4 w-1/2' onSubmit={handleFormSubmit}>
